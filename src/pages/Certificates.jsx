...
const sampleStudents = [
  { id: 'S001', name: 'Jahn Aknih', email: 'evolve@gmail.com', certificate: 'Evolve Robotics' },
  { id: 'S002', name: 'James Kanchar', email: 'evolve@abc.com', certificate: 'Advanced Machine Learning' },
  { id: 'S003', name: 'Jonas Math', email: 'evolve@gmail.com', certificate: 'Embedded Systems' },
]

export default function Certificates() {
  const [selected, setSelected] = useState([])
  const [template, setTemplate] = useState({ title: 'Certificate of Completion', footer: 'Evolve Robotics Academy' })
